...
from evaluation import convert_data, invert_vocab, load_vocab, convert_str, sort_batch,dataset
...
# =============================================================================
    ...
    parser.add_argument('--vfreq', type=int, default=750, help='frequency for validation')
